...
class PostInsertion_Page extends StatefulWidget {

  @override
  State<PostInsertion_Page> createState() => _PostInsertion_PageState();
}

class _PostInsertion_PageState extends State<PostInsertion_Page> {
  ...
  insertPost() async {
    var request = http.MultipartRequest('POST', Uri.parse('${url}polls/InserPost'));
  ...
  void initState() {
    super.initState();
    testInternet();
    lien_Controller.text="https://www.tiktok.com/@neapolis.car";
  }
